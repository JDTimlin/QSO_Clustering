...
ytrain = np.array(data['shenlabel'])
...
nproc = 25  #Number of processors on which to run
...
dataS82.write('SpIES_SHELA_Quasar_Canidates_Shen_zrange_JTmultiproc.fits', format='fits')
